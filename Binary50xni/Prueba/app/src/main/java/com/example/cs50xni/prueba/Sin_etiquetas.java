...
public class Sin_etiquetas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sin_etiquetas);
    ...
    public void OnclickButtonListener(View view)
    {
        if(!var )
        {
            ...
            {
                Ganastes();
                Toast.makeText(Sin_etiquetas.this, "Felicidades Ganastes", Toast.LENGTH_SHORT).show();//impriminos el resultado
            }
            var = true;
        }
        else
    ...
    public void OnclickButtonListener5(View view)
    {
        if(!var5 )
        {
            ...
            {
                Ganastes();
                Toast.makeText(Sin_etiquetas.this, "Gano", Toast.LENGTH_LONG).show();//impriminos el resultado
            }
            var5 = true;
        }
        else
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Sin_etiquetas.this, "Connectando...", "Espere por favor!!!");
        }
    ...
    public void onBackPressed()
    {
        ...
        ResetLed();
        Disconnect();
        Intent intent = new Intent(Sin_etiquetas.this, DeviceList.class);
